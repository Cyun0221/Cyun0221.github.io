...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_4、js-把字符串变成数字" tabindex="-1"><a class="header-anchor" href="#_4、js-把字符串变成数字" aria-hidden="true">#</a> 4、js 把字符串变成数字</h3>
